# Specification Quality Checklist: Semigroup Instance for Pattern
...
- Edge cases cover atomic patterns, single elements, nested patterns, and different nesting depths
